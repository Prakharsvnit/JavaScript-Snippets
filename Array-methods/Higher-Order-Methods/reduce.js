// reduce() method iterates over array and returns a single output value,doesn't changes original array
...
const salary = 15000;
const savings = expenses.reduce((accumulator, currentValue) => accumulator - currentValue,salary);
